...
function Home() {
    ...
    const handleSavePassword = async () => {
        if (allOptionsSelected && passwordGenerated && appName.trim() !== "" && userName.trim() !== "") {
            const savedData = {
                appName: appName,
                userName: userName,
                password: password,
            ...
            message.info("Please enable all options and provide App Name and User Name.");
        }
    };
    ...
    const handleDelete = () => {
        // handling delete option pending.
    };
                ...
                <div className="flex-1  p-10 flex flex-col justify-center items-center md:items-start md:w-1/2">
                    <div className="mb-8 text-center md:text-left">
                        ...
                        <p className="text-gray-600">
                            Generate strong and secure passwords to protect your online accounts. Customize your password
                            criteria and ensure your data's safety.
                        </p>
                    </div>
                    ...
                    <div className="fixed left-1/2 top-1/2 w-80 -translate-x-1/2 -translate-y-1/2 transform rounded-md bg-white p-5 sm:w-96">
                        <div className="space-y-5 bg-white ">
                            ...
                            <div className="flex justify-between">
                                <input className="w-full rounded-md" type="text" readOnly value={generatedPassword} />
                            </div>
